...
class Inventory:
    ...
    def Inventory(self, databaseName='GroupProjectDatabase.db', tableName='Inventory'):
        self.databaseName = databaseName
        self.tableName = tableName
        self.conn = sqlite3.connect(r"C:\Program Files\DB Browser for SQLite\Methods and Tools of Software Development 2023 folder\GroupProjectDatabase.db")
